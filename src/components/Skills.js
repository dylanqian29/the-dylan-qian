         ...
         <div className="skillz">
            <div className="skillz__category">
              ...
              <ul>
                ...
                <li className="skillz__category__item"> <i className="devicon-ruby-plain"></i> Ruby </li>
                ...
                <li className="skillz__category__item"> <i className="devicon-postgresql-plain"></i> SQL</li>
              </ul>
            </div>
            <div className="skillz__category">
              ...
              <ul>
                ...
                <li className="skillz__category__item"> <i className="devicon-rails-plain"></i> Ruby on Rails</li>
